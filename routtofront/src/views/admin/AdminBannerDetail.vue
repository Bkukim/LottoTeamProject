...
<div
  ...
  <div
    ...
    "
  >
    <label><b>배너 제목</b></label
    ><label style="display: flex; align-items: center; height: 100%">
      <input
        type="text"
        placeholder="배너 제목을 입력하세요"
        style="height: 35px; margin-right: 10px; width: 500px;"
        class="input-box"
        v-model="banner.bannerTitle"
      />
  ...
  <div
    ...
    "
  >
    <label><b>배너 내용</b></label
    ><label style="display: flex; align-items: center; height: 100%">
      <input
        type="text"
        placeholder="배너 내용을 입력하세요"
        style="height: 35px; margin-right: 10px; width: 500px; margin: 20px 10px;" 
        class="input-box"
        v-model="banner.bannerContent"
      />
  ...
  >
    <label class="mt-3"><b>배너 이미지2 변경</b> </label>
    <hr />
    <div>
      <div id="img-add">
        <label class="mt-3 mb-3"></label>
...
export default {
  ...
  methods: {
    ...
    previewBannerImg2() {
      this.banner.bannerImg2 = this.$refs.file02.files[0];
    },

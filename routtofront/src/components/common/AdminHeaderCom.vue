  ...
  <div :class="{ scrolled: scrolled }" class="kim-frame-14">
    ...
    <div class="kim-frame-14-in">
      ...
      <div class="kim-navbar">
        <router-link to="/shop/admin/order" class="kim-div3">주문관리</router-link>
        <router-link to="/admin-notice" class="kim-div3">공지사항</router-link>
        <router-link to="/shop/admin/add-product" class="kim-div3">상품등록</router-link>
        <router-link to="/shop/admin/manage" class="kim-div3">상품조회/수정</router-link>
        <router-link to="/shop/admin/refund" class="kim-div3">환불관리</router-link>

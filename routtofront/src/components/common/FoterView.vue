<template>
  <div class="footer_all">
    <div class="footer">
      <img
        class="routto-3-4"
        src="../../../src/assets/images/routto__3__4.png"
      />

      <div class="row">
        <div class="afe-24">
          <p>
            Permit Registration : 2017-SeoulGangnam-04392 <br>
            Fax : 02-6952-3376 ｜  Personal Information Manager : JEON Yong Kweon I 
            <br>Mail : cs@adaptkorea.com Copyright. OBGE All right reserved. Hosting by<br>
            cafe24.
          </p>
        </div>
        <div class="link">
